...
/**
 * CreateTransactionDetailDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateTransactionDetailDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTransactionDetailDto';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('external_tx_id', $data ?? [], '');
    }
    ...
    */
     ...
     * Sets symbol
     *
     * @param string $symbol The asset symbol (e.g., USDT, BTC, ETH)
     *
     * @return self
     */
     ...
     * Sets network
     *
     * @param string $network The network name (e.g., ETH, TRX, BTC, SOL)
     *
     * @return self
     */
     ...
     * Sets hash
     *
     * @param string $hash The transaction hash (unique)
     *
     * @return self
     */
     ...
     * Sets external_tx_id
     *
     * @param string|null $external_tx_id External transaction ID
     *
     * @return self
     */
