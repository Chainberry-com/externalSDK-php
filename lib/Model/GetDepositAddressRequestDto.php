...
/**
 * GetDepositAddressRequestDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetDepositAddressRequestDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetDepositAddressRequestDto';
    ...
    */
     ...
     * Sets api_token
     *
     * @param string $api_token Partner ID (API token)
     *
     * @return self
     */
     ...
     * Sets network
     *
     * @param string|null $network The network (e.g., ETH, BTC, SOL, TRX)
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string $currency The asset symbol (e.g., USDT, USDC)
     *
     * @return self
     */
     ...
     * Sets timestamp
     *
     * @param float $timestamp Timestamp for signature verification
     *
     * @return self
     */
     ...
     *
     * @param string $partner_user_id The partner user ID
     *
     * @return self
     */
     ...
     * Sets signature
     *
     * @param string $signature Payload signature for verification
     *
     * @return self
     */
