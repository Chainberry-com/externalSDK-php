...
/**
 * SubscribeRequestDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubscribeRequestDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscribeRequestDto';
    ...
    public const NETWORK_BTC_TESTNET = 'BTC Testnet';
    public const NETWORK_TRX_SHASTA = 'TRX Shasta';
    ...
    */
     ...
     * Sets addr
     *
     * @param string $addr The address to subscribe to
     *
     * @return self
     */
     ...
     * Sets network
     *
     * @param string $network The network to subscribe on
     *
     * @return self
     */
