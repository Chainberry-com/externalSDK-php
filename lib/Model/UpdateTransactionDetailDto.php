...
/**
 * UpdateTransactionDetailDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateTransactionDetailDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateTransactionDetailDto';
    ...
    */
     ...
     * Sets symbol
     *
     * @param string|null $symbol The asset symbol (e.g., USDT, BTC, ETH)
     *
     * @return self
     */
     ...
     * Sets network
     *
     * @param string|null $network The network name (e.g., ETH, TRX, BTC, SOL)
     *
     * @return self
     */
     ...
     * Sets hash
     *
     * @param string|null $hash The transaction hash (unique)
     *
     * @return self
     */
