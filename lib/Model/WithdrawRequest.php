...
class WithdrawRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_gateway_name'] === null) {
            $invalidProperties[] = "'payment_gateway_name' can't be null";
        }
     ...
     *
     * @param string $payment_gateway_name Payment Gateway Name is invalid. It should be one of the following ETH, BNB, TRX and align with the Currency field.
     *
     * @return self
     */
     ...
     *
     * @param string $withdraw_currency withdraw_currency
     *
     * @return self
     */
