...
/**
 * WithdrawRequestV2Dto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WithdrawRequestV2Dto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WithdrawRequestV2Dto';
    ...
    */
     ...
     * Sets network
     *
     * @param string|null $network Network is invalid. It should be one of the following ETH, BNB, POL, TRX, TON and align with the Currency field.
     *
     * @return self
     */
