...
class AutoConversionService
{
     ...
     * @throws \Exception
     */
    public function createAutoConversion(array $params): \OpenAPI\ClientV1\Model\AutoConversionResponseDto
    {
        $signedRequest = $this->getSignedAutoConversionRequest($params);
        
        try {
            $response = $this->apiSetup->getAutoConversionApi()->autoConversionControllerAutoConversionV1($signedRequest);
            return $response;
