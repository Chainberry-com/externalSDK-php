...
class DepositService
{
    ...
    public function createDeposit(array $params): \OpenAPI\ClientV1\Model\DepositDto
    {
        ...
        try {
            $response = $this->apiSetup->getDepositsApi()->depositControllerCreateDepositV1($signedRequest);
            return $response;
            ...
            try {
                ...
                if ($attempt === 0) {
                    try {
                        ...
                        $response = $this->apiSetup->getDepositsApi()->depositControllerGetDepositPaymentV1($paymentId);
