...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://localhost:3001/api/v1';
    ...
    {
        $report  = 'PHP SDK (OpenAPI\ClientV1) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.50' . PHP_EOL;
